    ...
    <footer className="nexus-footer">
      <div className="footer-inner">
        ...
        <div className="footer-brand">
          ...
          >
            MERIDIAN<span>BRIDGE</span>
          </button>
          <p className="footer-copy">© 2026 MeridianBridge<br />All rights reserved.</p>
        </div>
        ...
        <div className="footer-contact">
          ...
          <div className="footer-phones">
            <a href="tel:+12345678901" className="footer-phone-item">
              ...
              <span className="phone-num">+91 85003 87363</span>
            </a>
            <a href="tel:+917055957571" className="footer-phone-item">
              <span className="phone-lang">(HINDI)</span>
              <span className="phone-num">+91 70559 57571</span>
            </a>
            <a href="tel:+917217220933" className="footer-phone-item">
              <span className="phone-lang" style={{ visibility: 'hidden' }}>(HINDI)</span>
              <span className="phone-num">+91 72172 20933</span>
            </a>
