  ...
  return (
    <div className="homepage-root">
        ...
        <div className="section-inner">
          <div className="outcomes-grid">
            <div className="outcomes-left reveal">
              ...
              <p className="outcomes-sub">When the process is structured, the results follow. Here's what brands working with MeridanBridge consistently see.</p>
            </div>
      ...
      <section id="final-cta">
        ...
        <p className="cta-eyebrow reveal">↗ Work With MeridianBridge</p>
